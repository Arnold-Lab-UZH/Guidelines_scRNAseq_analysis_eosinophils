...
p <- ggplot(df, aes(x = norm_expression, fill = annotation == "Eosinophils")) +
  ...
  scale_fill_manual(values = c("grey", "#E22F27"), labels = c("Other", "Eosinophils"))
#ggsave("/scratch/khandl/technical/figures/Empty_droplets_by_Malat1/Mm_Malat1_histogram_Eos_highlighted.svg", width = 12, height = 8, plot = p)
