...
write.csv(df,file.path(doublet_tables_dir, "nFeature_upper_cutoff_doublet_rate_corr.csv"))
...
write.csv(deconvolution_crc_df,file.path(doublet_tables_dir, "upperFeature_cutoff_doublets_deconvolution_result_corr.csv"))

##### Save Seurat object 
saveRDS(obj, file.path(seurat_objects_dir, "Singlets_and_Doublets_Hs_NAT_tumor_PB_P1_to_P7_scCDC_annotated_gene_count_cutoff.rds"))
