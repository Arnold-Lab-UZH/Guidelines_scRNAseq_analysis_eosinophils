...
tumor_wt <- create_seurat_Mm_data(
  path_to_st_file = file.path(raw_data_GSE282765_Mm_colon_forced_intron_exon_dir, "Forced_cell_determination_intronic_and_exonic_Mm_AKPS_tumor_Expression_Data.st"), 
  project = "tumor_wt", condition = "tumor_wt",3,200)

disseminated_wt <- create_seurat_Mm_data(
  path_to_st_file = file.path(raw_data_GSE282765_Mm_colon_forced_intron_exon_dir, "Forced_cell_determination_intronic_and_exonic_Mm_AKPS_disseminated_ST07_Expression_Data.st"), 
  project = "disseminated_wt", condition = "disseminated_wt",3,200)

adult_colon_wt <- create_seurat_Mm_data(
  path_to_st_file = file.path(raw_data_GSE282765_Mm_colon_forced_intron_exon_dir, "Forced_cell_determination_intronic_and_exonic_Mm_colon_ST04_Expression_Data.st"), 
  project = "adult_colon_wt", condition = "adult_colon_wt",3,200)

adjacent_colon_wt <- create_seurat_Mm_data(
  path_to_st_file = file.path(raw_data_GSE282765_Mm_colon_forced_intron_exon_dir, "Forced_cell_determination_intronic_and_exonic_Mm_AKPS_NAT_ST03_Expression_Data.st"), 
...
### Save object
saveRDS(tumor, file = file.path(seurat_objects_dir,"Forced_cell_determination_intronic_and_exonic_reads_Mm_CRC_AKPS_tumor_NAT_diss.rds"))

##### Load R object 
obj <- readRDS(file = file.path(seurat_objects_dir,"Forced_cell_determination_intronic_and_exonic_reads_Mm_CRC_AKPS_tumor_NAT_diss.rds"))
...
##### Save object 
saveRDS(obj, file.path(seurat_objects_dir,"Mm_tumor_colon_NAT_diss_forced_cell_determination_with_intronic_reads_annotated.rds"))
