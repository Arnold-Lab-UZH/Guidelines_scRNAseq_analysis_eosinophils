...
other_h4 <- length(rownames(df_h4[df_h4$Eosinophils ==0 &df_h4$Eosinophils <= 0.25  ,]))
...
doublets_h5 <- length(rownames(df_h5[df_h5$Eosinophils >0.25 & df_h5$Eosinophils <= 0.75 ,]))
...
doublets_h7 <- length(rownames(df_h7[df_h7$Eosinophils >0.25 & df_h7$Eosinophils <= 0.75 ,]))
homo_h7 <- length(rownames(df_h7[df_h7$Eosinophils >0.75  ,]))
other_h7 <- length(rownames(df_h7[df_h7$Eosinophils ==0 &df_h7$Eosinophils <= 0.25  ,]))
...
ggsave(file.path(doublet_plots_dir, "Eos_score_doublets.svg"), width = 23, height = 8, plot = p)
