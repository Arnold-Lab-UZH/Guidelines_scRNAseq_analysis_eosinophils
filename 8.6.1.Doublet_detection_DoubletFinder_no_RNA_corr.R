...
write.csv(df,file.path(doublet_tables_dir, "DoubletFinder_doublet_rate_no_corr.csv"))
...
write.csv(deconvolution_crc_df,file.path(doublet_tables_dir, "DoubletFinder_wo_doublets_deconvolution_result_no_corr.csv"))

##### save Seurat object 
saveRDS(obj, file.path(seurat_objects_dir, "Singlets_and_Doublets_Hs_NAT_tumor_PB_P1_to_P7_annotated_DoubletFinder.rds"))
