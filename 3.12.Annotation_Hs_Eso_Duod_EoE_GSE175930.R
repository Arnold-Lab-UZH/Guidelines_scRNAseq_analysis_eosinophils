##########  Pre-processing of human EoE scRNAseq data ##########
# and https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE175930
# publications https://www.sciencedirect.com/science/article/pii/S009167492400602X
# and https://pubmed.ncbi.nlm.nih.gov/34389613/
...
Duodenum_EoE_rem1 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P249_Duodenum","EoE",3,200, "Duodenum_EoE_rem1","Duodenum_EoE_rem","EoE_Exp1","EoE_rem")
Duodenum_EoE_rem2 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P355_Duodenum","EoE",3,200, "Duodenum_EoE_rem2","Duodenum_EoE_rem","EoE_Exp2","EoE_rem")
Duodenum_EoE_rem3 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P468_Duodenum","EoE",3,200, "Duodenum_EoE_rem3","Duodenum_EoE_rem","EoE_Exp3","EoE_rem")
Duodenum_EoE_rem4 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P392_Duodenum","EoE",3,200, "Duodenum_EoE_rem4","Duodenum_EoE_rem","EoE_Exp4","EoE_rem")

Esophagus_EoE_rem1 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P249_Esophagus","EoE",3,200, "Esophagus_EoE_rem1","Esophagus_EoE_rem","EoE_Exp1","EoE_rem")
Esophagus_EoE_rem2 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P355_Esophagus","EoE",3,200, "Esophagus_EoE_rem2","Esophagus_EoE_rem","EoE_Exp2","EoE_rem")
Esophagus_EoE_rem3 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P468_Esophagus","EoE",3,200, "Esophagus_EoE_rem3","Esophagus_EoE_rem","EoE_Exp3","EoE_rem")
Esophagus_EoE_rem4 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P392_Esophagus","EoE",3,200, "Esophagus_EoE_rem4","Esophagus_EoE_rem","EoE_Exp4","EoE_rem")

Duodenum_EoE_active1 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P292_Duodenum","EoE",3,200, "Duodenum_EoE_active1","Duodenum_EoE_active","EoE_Exp5","EoE_act")
Duodenum_EoE_active2 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P354_Duodenum","EoE",3,200, "Duodenum_EoE_active2","Duodenum_EoE_active","EoE_Exp6","EoE_act")
Duodenum_EoE_active3 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P451_Duodenum","EoE",3,200, "Duodenum_EoE_active3","Duodenum_EoE_active","EoE_Exp7","EoE_act")
Duodenum_EoE_active5 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P474_Duodenum","EoE",3,200, "Duodenum_EoE_active3","Duodenum_EoE_active","EoE_Exp9","EoE_act")
Duodenum_EoE_active6 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P475_Duodenum","EoE",3,200, "Duodenum_EoE_active4","Duodenum_EoE_active","EoE_Exp10","EoE_act")

Esophagus_EoE_active1 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P292_Esophagus","EoE",3,200, "Esophagus_EoE_active1","Esophagus_EoE_active","EoE_Exp5","EoE_act")
Esophagus_EoE_active2 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P354_Esophagus","EoE",3,200, "Esophagus_EoE_active2","Esophagus_EoE_active","EoE_Exp6","EoE_act")
Esophagus_EoE_active3 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P451_Esophagus","EoE",3,200, "Esophagus_EoE_active3","Esophagus_EoE_active","EoE_Exp7","EoE_act")
Esophagus_EoE_active4 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P471_Esophagus","EoE",3,200, "Esophagus_EoE_active4","Esophagus_EoE_active","EoE_Exp8","EoE_act")
Esophagus_EoE_active5 <- create_seurat_public_data( "/scratch/khandl/8.GSE175930/P474_Esophagus","EoE",3,200, "Esophagus_EoE_active3","Esophagus_EoE_active","EoE_Exp9","EoE_act")
