##########  Pre-processing and annotation of human blood from asthmatic and control E-MTAB-14010 ##########
#Rodrigo-Muñoz et al. 2024
...
PB_ctrl1 <- create_seurat_public_data( "/scratch/khandl/4.E-MTAB-14010/Control1","Control1",3,200, "PB_control1","PB_healhty","Exp1","healthy")
PB_ctrl2 <- create_seurat_public_data( "/scratch/khandl/4.E-MTAB-14010/Control2","Control",3,200, "PB_control2","PB_healhty","Exp1","healthy")
PB_ctrl3 <- create_seurat_public_data( "/scratch/khandl/4.E-MTAB-14010/Control3","Control",3,200, "PB_control3","PB_healhty","Exp1","healthy")

PB_asthma1 <- create_seurat_public_data( "/scratch/khandl/4.E-MTAB-14010/Astma1","Asthma",3,200, "PB_asthma1","PB_Asthma","Exp1","asthma")
PB_asthma2 <- create_seurat_public_data( "/scratch/khandl/4.E-MTAB-14010/Astma2","Asthma",3,200, "PB_asthma2","PB_Asthma","Exp1","asthma")
PB_asthma3 <- create_seurat_public_data( "/scratch/khandl/4.E-MTAB-14010/Astma3","Asthma",3,200, "PB_asthma3","PB_Asthma","Exp1","asthma")
