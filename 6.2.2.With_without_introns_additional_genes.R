########## This code compares with and without intronic reads and the information gained  ##########

##### Set up environment 
setwd("/home/khandl")

##### on the example of PB healthy blood 
# GSE282765 
...
#all eos combined
Idents(obj) <- "reads"
DEG_to_csv_two_cond(obj,"RNA", "intronic_and_exonic","exonic_only",FALSE,0.25,paste0("/scratch/khandl/technical/figures/intron_exon/DEGs_eos_subtype_il5tg_allEos_intron_vs_exon_only.csv"))
