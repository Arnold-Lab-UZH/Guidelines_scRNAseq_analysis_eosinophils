...
ggsave(file.path(ambient_rna_plots_dir, "DecontX_feature_plot_Hs.svg"), width = 10, height = 8, plot = p)
...
### save data frame 
write.csv(df,file.path(ambient_rna_tables_dir, "decontX_Hs.csv"))
