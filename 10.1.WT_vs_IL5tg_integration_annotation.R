...
### change assay type Corrected to RNA in wt_colon 
#wt_colon[["RNA"]] <- wt_colon[["Corrected"]]
#DefaultAssay(wt_colon) <- "RNA"
#wt_colon[["Corrected"]] <- NULL

### extract blood, BM, colon WT no tumor and il5tg 
