...
##### Load seurat objects 
gene_counts_obj <- readRDS(file.path(seurat_objects_dir,"Singlets_and_Doublets_Hs_NAT_tumor_PB_P1_to_P7_scCDC_annotated_gene_count_cutoff.rds"))
scDblFinder_obj <- readRDS(file.path(seurat_objects_dir,"Singlets_and_Doublets_Hs_NAT_tumor_PB_P1_to_P7_scCDC_annotated_scDblFinder075.rds"))
DoubletFinder_obj <- readRDS(file.path(seurat_objects_dir,"Singlets_and_Doublets_Hs_NAT_tumor_PB_P1_to_P7_scCDC_annotated_DoubletFinder.rds"))
cell_hashing_obj <- readRDS(file.path(seurat_objects_dir,"Hs_tumor_NAT_forced_cell_determination_with_intronic_reads_multiplets_from_cell_hashing.rds"))
...
##### Load SCDC results
gene_counts_df <- read.csv(file.path(doublet_tables_dir, "upperFeature_cutoff_doublets_deconvolution_result_corr.csv"))
scDblFinder_df <- read.csv(file.path(doublet_tables_dir, "scDblFinder_wo_doublets_deconvolution_result075_RNA_corr.csv"))
DoubletFinder_df <- read.csv(file.path(doublet_tables_dir, "DoubletFinder_wo_doublets_deconvolution_result_corr.csv"))
cell_hashing_df <- read.csv(file.path(doublet_tables_dir, "cell_hashing_doublets_deconvolution_result.csv"))
...
ggsave(file.path(doublet_plots_dir, "SCDC_score_eos_across_methods.svg"), width = 10, height = 8, plot = p)
...
ggsave(file.path(doublet_plots_dir, "SCDC_score_neutro_across_methods.svg"), width = 10, height = 8, plot = p)
...
ggsave(file.path(doublet_plots_dir, "SCDC_score_mac_across_methods.svg"), width = 10, height = 8, plot = p)
