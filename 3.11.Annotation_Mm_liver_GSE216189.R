##########  Pre-processing of mouse liver ##########
#https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE216189
# https://www.nature.com/articles/s41467-023-43005-8
#GSE216189
...
liver_mets1 <- create_seurat_zUMI_outputs_public("/scratch/khandl/10.GSE216189/GSM7026580_Mets_sc1.dgecounts.rds", 
                                              project = "liverMets",3,200, condition = "Liver_mets1",batch = "batch1",tissue_oi = "liver",phenotype_oi <- "metastasis")

liver_mets2 <- create_seurat_zUMI_outputs_public("/scratch/khandl/10.GSE216189/GSM7026581_Mets_sc2.dgecounts.rds", 
                                              project = "liverMets", 3,200,  condition = "Liver_mets2",batch = "batch1",tissue_oi = "liver",phenotype_oi <- "metastasis")

liver_mets3 <- create_seurat_zUMI_outputs_public("/scratch/khandl/10.GSE216189/GSM6661394_WT.dgecounts.rds", 
                                              project = "liverMets",3,200,   condition = "Liver_healthy1",batch = "batch2",tissue_oi = "liver",phenotype_oi <- "healthy")

liver_mets4 <- create_seurat_zUMI_outputs_public("/scratch/khandl/10.GSE216189/GSM6661376_MetsM1.dgecounts.rds", 
                                              project = "liverMets",3,200,    condition = "Liver_mets3",batch = "batch3",tissue_oi = "liver",phenotype_oi <- "metastasis")

liver_mets5 <- create_seurat_zUMI_outputs_public("/scratch/khandl/10.GSE216189/GSM6661378_MetsM3.dgecounts.rds", 
                                              project = "liverMets",3,200,  condition = "Liver_mets4",batch = "batch3",tissue_oi = "liver",phenotype_oi <- "metastasis")

liver_mets6 <- create_seurat_zUMI_outputs_public("/scratch/khandl/10.GSE216189/GSM6661380_MetsM4.dgecounts.rds", 
                                              project = "liverMets",3,200,  condition = "Liver_mets5",batch = "batch3",tissue_oi = "liver",phenotype_oi <- "metastasis")

liver_mets7 <- create_seurat_zUMI_outputs_public("/scratch/khandl/10.GSE216189/GSM6661382_Mets4M1.dgecounts.rds", 
                                              project = "liverMets",3,200, condition = "Liver_mets6",batch = "batch4",tissue_oi = "liver",phenotype_oi <- "metastasis")

liver_mets8 <- create_seurat_zUMI_outputs_public("/scratch/khandl/10.GSE216189/GSM6661384_Mets4M2.dgecounts.rds", 
                                              project = "liverMets", 3,200, condition = "Liver_mets7",batch = "batch4",tissue_oi = "liver",phenotype_oi <- "metastasis")

liver_mets9 <- create_seurat_zUMI_outputs_public("/scratch/khandl/10.GSE216189/GSM6661388_Mets6M1.dgecounts.rds", 
                                              project = "liverMets",3,200,  condition = "Liver_mets8",batch = "batch5",tissue_oi = "liver",phenotype_oi <- "metastasis")

liver_mets10 <- create_seurat_zUMI_outputs_public("/scratch/khandl/10.GSE216189/GSM6661390_Mets6M2.dgecounts.rds", 
                                               project = "liverMets",3,200,  condition = "Liver_mets9",batch = "batch5",tissue_oi = "liver",phenotype_oi <- "metastasis")

liver_mets11 <- create_seurat_zUMI_outputs_public("/scratch/khandl/10.GSE216189/GSM6661392_Mets6M3.dgecounts.rds", 
                                               project = "liverMets",3,200,  condition = "Liver_mets10",batch = "batch5",tissue_oi = "liver",phenotype_oi <- "metastasis")

liver_mets12 <- create_seurat_zUMI_outputs_public("/scratch/khandl/10.GSE216189/GSM6661386_MetsM5.dgecounts.rds", 
...
obj <- RunUMAP(obj, reduction = "pca", dims = 1:15,return.model = TRUE)
DimPlot(obj,reduction = "umap", label = TRUE, group.by = "seurat_clusters", label.size = 5)
DimPlot(obj,reduction = "umap", label = TRUE, group.by = "batch")
...
p <- DotPlot(obj, features = unique(markers),dot.scale = 6, scale = TRUE, assay = "RNA",cols = c("white","darkred")) + 
